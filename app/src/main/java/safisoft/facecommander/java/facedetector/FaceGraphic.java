...
import safisoft.facecommander.GraphicOverlay.Graphic;
...
public class FaceGraphic extends Graphic {
  ...
  private static final int[][] COLORS =
      new int[][] {
        ...
        {Color.parseColor("#40C9CE"), Color.WHITE},
  ...
  public void draw(Canvas canvas) {
    ...
    if (leftEye != null) {
      float leftEyeLeft =
          translateX(leftEye.getPosition().x) - idPaints[colorID].measureText("Right Eye") / 2.0f;
      canvas.drawRect(
    ...
    if (rightEye != null) {
      float rightEyeLeft =
          translateX(rightEye.getPosition().x) - idPaints[colorID].measureText("Left Eye") / 2.0f;
      canvas.drawRect(
